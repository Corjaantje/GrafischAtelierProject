@section('footer')
    <footer id="footer">
        ...
        <div id="footerimages" class="col-lg-4 col-md-4 col-sm-4 col-sm-offset-0 col-xs-10 col-xs-offset-1">
            <img src="{{ URL::asset('img/w2f_logo.png') }}" alt="w2f logo" width="250px">
