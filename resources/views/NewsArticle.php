		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-sm-offset-0 col-xs-10 col-xs-offset-1">
					...
					<img src="../assets/Images/NewsImages/KarinSchreppersFallingLeaf.jpg" style="width: 100%" />
					<br>
					Karin Schreppers, Falling Leaf
					<br>
				
					<img src="../assets/Images/NewsImages/PeterKoeneOmhelsDeNacht.jpg" style="width: 100%">
					<br>
