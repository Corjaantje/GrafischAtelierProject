...
<div class="container-cms">
    <br><br><br>
    <h2><b>Nieuwe sponsor</b> @include('layouts.tooltip', array('text'=>'Hier kun je een nieuwe sponsor toevoegen. Deze zal ook in de footer van de pagina tevoorschijn komen.')) </h2>
    <br>
