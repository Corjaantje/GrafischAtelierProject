    ...
    public function run()
    {
        ...
        $workshops = array(
            array(
                ...
                'visible' => 1,
	            'start_time' => new DateTime('2017-3-10 9:30:0'),
	            'end_time' => new DateTime('2017-3-10 16:00:0'),
                'cost' => 0,
                'template' => 1,
            ),
            array(
                ...
                'visible' => 1,
	            'start_time' => new DateTime('2017-5-27 9:0:0'),
	            'end_time' => new DateTime('2017-5-27 16:30:0'),
                'cost' => 0,
                'template' => 1,
            ),
            array(
                ...
                'visible' => 1,
	            'start_time' => new DateTime('2017-3-18 10:0:0'),
	            'end_time' => new DateTime('2017-3-18 13:0:0'),
                'cost' => 0,
                'template' => 1,
            ),
            array(
                ...
                'visible' => 1,
	            'start_time' => new DateTime('2017-3-22 10:0:0'),
	            'end_time' => new DateTime('2017-3-22 16:0:0'),
                'cost' => 0,
                'template' => 1,
            ),
            array(
                ...
                'visible' => 1,
	            'start_time' => new DateTime('2017-5-13 10:0:0'),
	            'end_time' => new DateTime('2017-5-13 12:30:0'),
                'cost' => 0,
                'template' => 1,
            )
        );
